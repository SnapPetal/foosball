...
@NoArgsConstructor
@Entity
@Table(name = "tournament_standings", schema = "foosball",
        uniqueConstraints = {@UniqueConstraint(name = "uk_tournament_registration_standing", 
...
public class TournamentStanding {
    ...
    public String getSummary() {
        return String.format("P:%d W:%d L:%d D:%d GF:%d GA:%d GD:%d Pts:%.1f",
                gamesPlayed, wins, losses, draws, goalsFor, goalsAgainst, 
                goalDifference, points.doubleValue());
    }

...
@NoArgsConstructor
@Entity
@Table(name = "tournament_matches", schema = "foosball",
        uniqueConstraints = {@UniqueConstraint(name = "uk_tournament_round_match", 
...
public class TournamentMatch {
    ...
    public TournamentMatch(Tournament tournament, Integer roundNumber, Integer matchNumber, 
                          TournamentRegistration team1, TournamentRegistration team2) {
    ...
    private boolean matchesTeam(TournamentRegistration registration, Player player1, Player player2) {
        if (registration.isTeam()) {
            return (registration.getPlayer().equals(player1) && registration.getPartner().equals(player2)) ||
                   (registration.getPlayer().equals(player2) && registration.getPartner().equals(player1));
        } else {
            return registration.getPlayer().equals(player1) || registration.getPlayer().equals(player2);
        }
    }
    ...
    public String getDisplayName() {
        String bracket = bracketType == BracketType.MAIN ? "" : " (" + bracketType.name().toLowerCase() + ")";
